...
This is an R Markdown document serves as the report and code for Task 1: Data Extraction
of the City of Cape Town Data Science Unit Code Challenge. The code by itself
...
existing file to test if the extraction was successful. The time taken to perform
these operations was logged to the command line and is presented in the table below.
